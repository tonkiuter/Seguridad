...
@section('content')
    ...
    <a href="{{ route('paseSalida.create') }}">Crear Pase de Salida</a>

    <ul>
        @forelse ($paseSalida as $paseSalidaItem)

            <li>{{ $paseSalidaItem->CodigoReporte }}</li>
                <li>{{ $paseSalidaItem->CodigoAlumno }}</li>
                    <li>{{ $paseSalidaItem->Fecha }}</li>
...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST" class="needs-validation" action="{{ route('paseSalida.store') }}">
            @csrf
            <div class="container">
                <div class="row">
{{--                     <div class="col-md">
                    ...
                    <div class ="col-md">
                        Codigo_Repote: <input class="form-control" type="text" required name= 'CodigoReporte'><br>
                    </div>
                    <div class="col-md">
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        Telefono_sello: <input class="form-control" type="text" required name="Sello"><br>
                    </div>
                    <div class= "col-md">
                       FotoIdb: <input class="form-control" type= "text" required name= 'FotoIdB'>      
                    </div><br>
                    <div class= "col-md">
                        FotoIdF: <input class="form-control" type= "text" required name= 'FotoIdF'>      
                     </div>
                    <div class="col-md">
                        <p>
                            ...
                            <textarea class="form-control" placeholder="Descripcion del vehiculo..." required name= 'Descripcion'></textarea>
                        </p>
                    </div>
                </div>
            </div>
