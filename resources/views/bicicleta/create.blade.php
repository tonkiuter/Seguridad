        ...
        <form method = "POST" action="{{ route('bicicleta.store') }}">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class ="col-md">
                        Carrera: <input class="form-control" type="text" required><br>
                    </div>
                    <div class="col-md">
                        Codigo: <input class="form-control" type="text" required  name='CodigoReporte' ><br>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
                    ...
                    <div class="col-md">
                        FotoIdF: <input class="form-control" type="text" name= 'FotoIdF'> 
                    </div><br>

                    <div class="col-md">
                        FotoIdb: <input class="form-control" type="text" name= 'FotoIdB'> 
                    </div><br>
            ...
            <button class='btn btn-primary btn-lg btn-success' href=''>Enviar</button>
        </form>
...
{{--         <script>
        ...
        <div align= "center">
            ...
            <a class='btn btn-primary btn-lg btn-success' href=''>Enviar</a>
